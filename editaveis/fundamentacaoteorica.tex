\chapter[Fundamentação Teórica]{Fundamentação Teórica}
  ...
  \section[Paradigmas de Solução de Problema]{Paradigmas de Solução de Problema}
    ...
    Vai ter que fazer algoritmicamente -> resolve problemas com -> Definição paradigma resolução -> mais conhecidos são

    \subsection[Busca Completa]{Busca Completa}
      Definição -> exemplo (elencar todas as permutações) -> aplicação no projeto (primeira versão era DFS sem DP)
