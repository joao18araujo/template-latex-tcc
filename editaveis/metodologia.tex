\chapter[Metodologia]{Metodologia} \label{c2}
  ...
  \begin{enumerate}
    ...
    \item Ruby On Rails \footnotemark \footnotetext{\url{http://www.cplusplus.com/}}, \textit{framework} para aplicações \textit{web}. Utilizado para desenvolvimento de uma camada \textit{front-end} para a aplicação;
