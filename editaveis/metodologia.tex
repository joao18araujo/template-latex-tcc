\chapter[Metodologia]{Metodologia} \label{c2}
  ...
  \begin{enumerate}
    ...
    \item C++\footnotemark \footnotetext{\url{http://www.cplusplus.com/}}, linguagem de programação compilada multiparadigma. Será utilizada como linguagem de implementação principal pelo suporte à programação orientada a objetos e domínio que a equipe tem dela;
